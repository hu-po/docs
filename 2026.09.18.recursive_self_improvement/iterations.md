...
- Section sizes: 5 / 5 / 6 / 7 / 5 / 2 / 5 / 5 / 6 (57 slides). 06 is 2 by design (all six Dream-RSI figures are in the deck). 04 is at 7 (round 7 added PACEvolve++ because it is the blurb's own sentence; do not add to 04 again without removing). 03 and 09 at 6, full. Room: 08 (5), 01/02/05 (5), 07 (5, non-Dream-RSI only). Deck is 3 under the 60 polish trigger: round 8 may add 2 at most, round 9 at most 1, then polish. Weakest-on-their-own remaining: Dreamer F1 in 05 (kept because it is where the word comes from), SwarmResearch F1 in 04.
- Dream-RSI repo (2026-09-17 round 7 re-check): still paper + assets, 4 commits (last: Sep 16 citation tweak in README); "Discovered programs / Full codebase / Reproduction scripts: being prepared". dream-rsi.com unchanged.
